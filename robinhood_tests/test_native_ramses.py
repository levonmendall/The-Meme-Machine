...
class RamsesInventoryWatchTests(unittest.TestCase):
    ...
    def test_watch_configuration_is_bounded_and_prospective(self):
        ...
        self.assertEqual(ramses_capture.WATCH_COHORT_COUNT,1)
        self.assertGreaterEqual(ramses_capture.RANK_POOL_COUNT,86)
        self.assertLessEqual(ramses_capture.RANK_POOL_COUNT,96)
        self.assertEqual(ramses_capture.WATCH_SLOT_SECONDS,300)
        self.assertEqual(ramses_capture.ACTIVITY_WAIT_SECONDS,300)
        self.assertEqual(ramses_capture.ACTIVITY_POLL_SECONDS,15)
        self.assertGreaterEqual(ramses_capture.FINALITY_WAIT_SECONDS,75)
