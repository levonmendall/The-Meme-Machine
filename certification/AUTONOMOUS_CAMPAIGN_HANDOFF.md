...
### e552c288 fresh smoke accepted; independent replacement hour authorized by its passed gates

Exacte552c288e6dd6c9028819cc4883890303dbf9524, workflow35600287474/smokejob106334511622/check106335082765, completed600.535796637seconds of concurrent observation and normal drain (total1605.7450289590001seconds). All four exits0, zero restarts/unexpected exits, all current books reconciled/flat, source manifest and all four canonical overlay hashes match. Complete standard review106343750324 and independent range-recovery review35601281616/job106337725996 both passed.71files and18SQLite backups verified with zero integrity failures and all provider archives complete.

Smoke artifact10640770324:214964619bytes,SHA256285071902eab44f28c9eacf9dbf306ec07af7f8cccad8102608581067d3c9d2d. Standard full-review artifact10640085596:1035908bytes,SHA2568a8bfb63fecab27622e9d50462dcd66e8f3c3835d82e5e2bf5a5715bb48aa9f1. Independent recovery audit10640300298:1037217bytes,SHA256ec9ff5d319005b16f9aa14b3dc67e4ceb531ba3f397c3619663c0a4fcca0ad79.

Pons broad observation stayed near current authenticated evidence, instead of accumulating the prior10695+block backlog. The last successful broad batch ended at68808069 at1789994827.676873418. Near-contemporaneous authenticated state header68808031 had timestamp1789994823 (observed1789994828.715864718,age5.716seconds); no latest-tag header was requested because there were no fills. Feed header age at the600-second boundary was0.635seconds and stayed around1second under candidate work. Actual post-warmup logs were2361CurveBuys and2002CurveSells; warmup286buys/225sells.284minimal-state attempts/215complete states,53prospects,19full evaluations,0qualifiers/fills. Native genesis/cash1000000000000000000,basis/reserved/unsettled0,capital integral complete.

The single Pons eth_getLogs RPC-32602 was a genuine provider boundary on one four-member batch for68803166..68803202, physical4552304b-a83b-4fb3-999d-88d5541f2f69:224 at1789994339.126530135. The existing recovery read eth_blockNumber68803214 (physical:225), then recovered the original37-block interval with bounded single-block queries before advancing. All logs and failed request identity remain retained. Native retry_count0 does not count these explicit fallback calls as SDK retries. The underlying provider's detailed cause is not inferred from code alone; the original failure's HTTP status is unavailable in the native exception record, explicitlyNULL, while its RPCcode/method/parameters are preserved. No429or persistent pressure followed, and live feed lag returned toabout1second. No unrelated work was deduplicated and no failed range was skipped.

Pump:631discovered,2strategy prospects,32complete evidence attempts,0qualifiers/fills,1280physical transports; getTransactionmaximum batch8,0provider errors/0GPA requests/0null-body failures. Window2021complete/8321expired (8079before transport,242after); research178complete/8before-transport expired; prefetch3534complete/1739expired(1543before/196after),152retired.114prefetch consumers stillwaiting in the native snapshot received explicit append-only shutdown terminals:108censored and6expired, not completed evidence. One physical-governor deadline miss,4capacity waits,79post-transport-late phases; no queue-capacity rejection or provider429.11089actual finalized-log negative-screen pool/signature exclusions. Lower logical loss and more completed window evidence than the defective prefilter smokes are observed, while differing natural demand prevents controlled causal claims.

Meteora:50pools,10admissions,3economic vectors,70signature-history members,0provider errors,0qualifiers. Ramses:3scans/full283-poolinventory,114grants/0misses,0qualifiers; maximum admission wait3.361seconds. All four lanes have0natural/forced settlements in this smoke and remain naturally incomplete; no qualifier was fabricated. All raw failure/incomplete evidence is retained.

Final pre-hour hygiene found only exact35600287474 active, no queued/waiting market validations, and one documentation-only pending workflow without a live marker. Fresh hourly job106343865628 is rerunning exact-revision deterministic/source/resource gates before fresh market processes. No smoke or superseded-hour time counts toward its3600seconds. Historical seven unresolved Pons positions and the older c457 archive gap remain explicitly unresolved.


### e552c288 replacement hour failed at startup; guarded cancellation requested

Hourly job106343865628/check106344804646 started2026-09-21T13:06:12Z. Pump exited1 after0.222157544seconds, with zero provider requests, zero discovered opportunities/qualifiers/fills and zero basis/reservations. Four-lane overlap stopped at0.216384236seconds. This hour is invalid and none of its time is certification time. The exact startup exception is not yet diagnosed; no cause is inferred merely from the zero-transport observation.

At elapsed118.814109442seconds all four lanes reported open_positions0, qualifiers0/naturals0 and reconciliation. Pons genesis book was fully observed with capital integral complete, zero remaining basis/reserved/unsettled; Pump/Meteora/Ramses were likewise flat. The targeted cancellation helper re-reads a<=45second-old exact-SHA live snapshot and refuses cancellation unless all four lanes remain flat/reconciled, qualifiers equal actual settled lifecycles, all basis/reservations/pending/unsettled balances are zero and each Ramses quote-asset book is uncommitted. It targets only35600287474@e552c288 and preserves its exact snapshot, artifact metadata and reason. The existing cancellation archive/quiesce hooks retain the startup/process/database evidence. No repair or replacement live run begins before diagnosis and fresh gates.


### e552 replacement-hour startup failure preserved
Workflow 35600287474 hourly job106343865628 cancelled by exact-exposure-guarded helper35603804178/job106345943634. All four lanes flat at cancellation; no observation credit. Full failed-hour artifact10640986145, 7409573bytes, SHA25682ab3f4d1c75df89f55b661d97721c2b6458ce78b3b3ed6184d4a7f16cd24281. Pump exit1 after0.222157544s beforeRPC; cause unknown pending read-only trace/SQLite audit. Accepted e552smoke remains preserved, but hour not certified. Historical unresolved exposures remain unchanged.


### Confirmed shared-broker startup defect and implementation repair
Read-only audit35604786396/job106349115106 verified64files including18SQLiteonline backups, zero integrity failures. Pump traceback conclusively identifies sqlite3.OperationalError: database is locked at EvidenceBroker.__init__ PRAGMA journal_mode=WAL. Otherlane KeyboardInterrupts are deliberate flat-run cancellation, not independent implementation crashes. Elapsed211.877044924s, overlap0.216384236s; no certification credit.
Repair both Pump/Meteora shared broker startup with one30-second monotonic bound around WAL transition, retry ONLY SQLite BUSY/LOCKED codes, zero busy timeout during bounded retry, restore normal30000ms busy timeout afterwards; close constructor connection on failure. No provider, consumer deadline, strategy, limits, accounting or market-scope changes. Add6 tests per Solana lane for actual locked journal transition with retaineddata, six simultaneous spawned processes with appendonlyintegrity, persistentbusy includingextendedcodes, nonlockfailclosed, failedconstructorcleanup, memoryDBsupport. Full deterministic/canonical/frozenpolicy/resource build required before promotion. Retain all prior overlays/repairs and allhistoricalevidence.
Cancellation guard35603804178 verified snapshotage27.387115s; auditartifact10640306524 SHA256c29424b8ee64d7e507a99e704a3ce025f82704cfeda983c6998607fdad1f6dc8.


### WAL startup repair promoted after complete deterministic verification
Build35605017296/job106349866242@1550ccf734d3eded44b8833638d968be656414b3 PASS: Pump310, Meteora407, Pons316, Ramses277 =1310lane tests;78supervisor tests;3resourcegates. Sixnewstartupregressions pass in eachSolanalane. All frozen files/sourcepins unchanged, alloverlays reapply byte-for-byte. Buildartifact10641717534,230352bytes,SHA256847fd58fd8bfdf8e2abc516434002839c7c7706182e916938759da9794661574; all gate commands/output stored under certification/results/hosted-frozen-repair/shared-broker-wal-startup/.
Candidate overlays: Pump845ec699da07f7ea46401dd16e1c44a39867645522de4ba90f4a304b29ff5bf4; Meteora8745586a5ca36863c97cfb9eb65a7ce5eafbb74f6bad6fbf298afcbb8d1d3c55; Pons30473cf97e5284645a5981fad547d46205e9ba62dfa930d34c7e12ccef874089; Ramses4ad9be892befa24ba698778ff9736b43fdb3c36224333b2d906eb1a435c5b23e. Manifest7c2505cc65e599929e58511f2463875f86228232d30f053754bf0ec9ef639226 unchanged.
Prelaunch API active/queued/pending/waiting all empty; main54712c4 unchanged; PR93c0b8bfb separatepolicyhead unchanged. All four sourcebranchheads rechecked exactfrozenpins. This commit requests ONE fresh600s smoke, complete native/archive/frontier review, then ONE independent3600s hour from freshprocesses. No prior time reused. Lifecycle/drain clocks remainoriginal; no recurrentjobs.
Startupaudit10641856635 SHA2561507b3a30a2bfee491300bf3ef52c2679eedade24915553a3f619484340b1a68. Failed e552hour nativegenesisbooks remainflat/noquals/fills, but cancellation final completeness flags are false for3interruptedlanes; no normaldrain/replaycertification is inferred. Rawfailedresult preserves allflags. Livehourcheck correctlyterminalcancelled.
