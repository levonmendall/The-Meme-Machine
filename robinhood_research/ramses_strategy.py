...
POLICY = {
    ...
    "policy_revision": "machinery-proof-v2",
    "policy_purpose": "natural_paper_machinery_proof_not_profitability_claim",
    "machinery_proof_only": True,
    "one_natural_settled_lifecycle_target": True,
    "fee_pulse": {
