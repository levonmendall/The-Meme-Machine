...
NATURAL_BUDGET=max(10,min(int(os.environ.get('MM_MARKET_NATIVE_OUTCOME_NATURAL_BUDGET','180')),180))
PRIORITY_BUDGET=max(1,min(int(os.environ.get('MM_MARKET_NATIVE_OUTCOME_PRIORITY_BUDGET','240')),240))
EXTRA_EVIDENCE_BUDGET=max(0,min(int(os.environ.get('MM_MARKET_NATIVE_OUTCOME_EXTRA_EVIDENCE_BUDGET','240')),240))
EXTRA_EVIDENCE_PER_SLOT=max(1,min(int(os.environ.get('MM_MARKET_NATIVE_OUTCOME_EXTRA_EVIDENCE_PER_SLOT','5')),5))
